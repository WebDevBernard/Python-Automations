...
btn_size = (8, 3)
dpad_button_style = {'button_color': ('#FFFFFF', '#505050'), 'border_width': 3, 'pad': (0, 0)}
side_button_style = {'button_color': ('#FFFFFF', '#C04080'), 'border_width': 3, 'pad': (0, 0)}
bottom_button_style = {'button_color': ('#000000', '#808080'), 'border_width': 3, 'pad': (0, 0)}
...
def create_window():
    dpad_layout = [
        [sg.Text('Suetendo GAME BOY™', justification='left', font=('Helvetica', 14, 'bold'))],
        [sg.Text('', size=(1, 1))],
        ...
        [sg.Button('Manual Renewal Letter', size=btn_size, **dpad_button_style),
         sg.Text('', size=(4, 1)),
         sg.Button('ICBC E-Stamp', size=btn_size, **dpad_button_style)],
        [sg.Text('', size=(1, 1)), sg.Button('Instant CSIO', size=btn_size, **dpad_button_style), sg.Text('', size=(1, 1))],
        [sg.Text('', size=(1, 1))]
    ]

    layout = [
        [sg.Multiline(default_text="Welcome!\nPress buttons to interact.", size=(40, 12),
                      key='-SCREEN-', background_color='#8BAC0F', text_color='#000000',
                      disabled=True, border_width=2, pad=(0, 5))],

        [sg.Column(dpad_layout, element_justification='center', pad=(5, 0)),
         sg.Column([
             [sg.Button('Copy & Rename ICBC', size=btn_size, **side_button_style),
              sg.Button('Auto Renewal Letter', size=btn_size, **side_button_style)],
             [sg.Text('B', size=btn_size, justification='center'),
              sg.Text('A', size=btn_size, justification='center')]
         ], element_justification='center', pad=(15, 0))],
    ...
    return sg.Window('Game Boy Emulator', layout, element_justification='center', finalize=True)
